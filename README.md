...
```
{
  ...
  "password": "CultOfATree"; // required, string, min-length: 6 symbols
}
```
...
```
{
	"oldPassword": "CultOfATree", // required, string, should match with user's password
